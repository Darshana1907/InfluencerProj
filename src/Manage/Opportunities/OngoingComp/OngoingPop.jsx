...
const OngoingPop = ({ isModalVisible, setIsModalVisible, selectData}) => {
  ...
  return (
    <>
        {isModalVisible && ( <div className="fixed inset-0 h-[1600px]  top-[-6%] z-50 flex items-center justify-center bg-black bg-opacity-50">
            ...
            <div className="p-5 text-start">
              ...
              <div className="py-4">
                ...
                <div className="flex justify-between py-2">
                  ...
                  <div className="text-[14px] font-body font-normal text-[#000000]">Payment /  {selectData.balance} </div>
                </div>
              </div>
