          ...
          <div className="bg-white absolute top-[5%] w-[529px] h-[606px] p-4 rounded-md">
            ...
            <div className="p-5 text-start">
              <div className="flex items-center space-x-4 text-start">
                ...
                <div><h1 className="text-[26px] font-body font-semibold text-[#0066FF]">{selectData.title}</h1>
                <p className="text-[12px] font-body font-normal text-[#797A7B]">{selectData.name}</p></div>
              </div>

              <div className="py-2">
              <p className="text-[12px] font-body font-normal text-[#797A7B]"> {selectData.description} </p>
              </div>
              ...
              <div className="py-4">
                ...
                <div className="flex justify-between py-2">
                  ...
                  <div className="text-[14px] font-body font-normal text-[#000000]">{selectData.startDate}</div>
                </div>

                {/* End Date */}
                <div className="flex justify-between py-2">
                  <div className="text-[12px] font-body font-normal text-[#797A7B]">End Date:</div>
                  <div className="text-[14px] font-body font-normal text-[#000000]"> {selectData.endDate} </div>
                </div>
                ...
                <div className="flex justify-between py-2">
                  ...
                  <div className="text-[14px] font-body font-normal text-[#000000]">Payment / $ {selectData.payment} </div>
                </div>
              </div>
              ...
              <button onClick={handleCancel} className="text-[14px] border-2 border-[#0066ff]  px-4 w-[128px] h-[35px] rounded-[4px] cursor-pointer font-body font-normal text-[#0066Ff]">
                  Cancel
                </button>
                <button className=" text-white text-[14px] font-body font-normal bg-[#0066ff]  px-[16px] w-[300px] h-[35px] rounded-[4px]" onClick={handleApply}>
                  Apply
                </button>
